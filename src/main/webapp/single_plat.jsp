...
<html lang="en">
  ...
  <body>
    	...
    	<form method="POST">
    		<div class="row">
    			...
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="<%= plat.getImage() %>" class="image-popup"><img src="<%= plat.getImage() %>" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				<h3><%=plat.getNom_plat() %></h3>
          	...
          	<p><button  role="button" type="submit" name="add" class="btn btn-dark py-3 px-5">Add to Cart</button></p>
    			</div>
    ...
    <section class="ftco-section">
        ...
        <% 
        ArrayList<Plat> platByType = new ArrayList<Plat>();
    						platByType= (ArrayList)request.getAttribute("platByType");
        for(Plat pl:platByType){
       %>
        	...
        	<div class="col-md-3">
        		<div class="menu-entry">
    					<a href="#" class="img" style="background-image: url(<%=pl.getImage() %>);"></a>
    					<div class="text text-center pt-4">
    						<h3><a href="#"><%=pl.getNom_plat() %></a></h3>
    						<p>A small river named Duden flows by their place and supplies</p>
    						<p class="price"><span><%=pl.getPrix() %></span></p>
    						<p><a href="Single_plat?id_plat=<%=pl.getId_plat()%>" class="btn btn-primary btn-outline-primary">Voir plat</a></p>
